...
class Post {
    ...
    // MARK: Constructor
    private init(postID: String, userID: String, photoURL: String, caption: String, likesCount: Int, usersLike: [String:Bool]) {
        self.postID = postID
        self.userID = userID
    ...
    static func transform(from dic: [String: Any], id: String) -> Post? {
        ...
        return Post(postID: id, userID: userID, photoURL: photoURL, caption: caption, likesCount: likeCount, usersLike: usersLike)
    }
}
